...
export const StoreProvider: React.FC<{ children: React.ReactNode }> = ({ children }) => {
  ...
  const [settings, setSettings] = useState<Settings>(() => {
    ...
    return {
      ...
      supportMessengerTitle: 'Messenger',
      supportMessengerDescription: 'Chat with us on Facebook Messenger for quick support.',
      supportMessengerLink: 'https://m.me/yourpage',
